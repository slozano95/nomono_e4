...
settings = Config()
app_configs: dict[str, Any] = {"title": "BFF SMAE"}
...
async def app_startup():
    global tasks
    global eventos
    task1 = asyncio.ensure_future(suscribirse_a_topico("eventos-compania", "bff", "public/default/eventos-compania", eventos=eventos))
    tasks.append(task1)
