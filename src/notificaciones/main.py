...
HOSTNAME = os.getenv('PULSAR_ADDRESS', default="127.0.0.1")

client = pulsar.Client(f'pulsar://{HOSTNAME}:6650')
consumer = client.subscribe('eventos-compania', consumer_type=_pulsar.ConsumerType.Shared, subscription_name='sub-notificacion-eventos-compania', schema=AvroSchema(EventoReservaCreada))
